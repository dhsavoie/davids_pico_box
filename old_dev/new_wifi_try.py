...
if not wlan:
    print(f"Connect to wifi {pico_AP}, password {pico_AP_pw}, then enter wifi info at http:// 192.168.4.1")
    captive_portal()
else:
    ...
    while True:
        ...
        print(n)
        if n == 5:
            print("DEBUG: Forcing wifi disconnect")
            log("DEBUG: Forcing wifi disconnect")
            wlan.disconnect()
